...
import com.aok.instagramclone.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void signIn(View view){
        ...
        if(email.equals("") || password.equals("")){
            ...
            Toast.makeText(MainActivity.this, "Email adresi veya parola girilmedi", Toast.LENGTH_SHORT).show();
